...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased relative">
        ...
        <main class="">
                ...
                <div class="card-container grid grid-cols-4 gap-9 ">
                    ...
                    <div class="card">
                        <div class="img-container relative">
                            <img class="shadow-sm shadow-black/30" src="/images/spiaggia_vietnam.jpg" alt="">
                        </div>
                        ...
                        <div class="flex">
                            <input class="" type="checkbox" name="import-duty" id="import-duty">
                            <label class="pl-1" for="import-duty">Apply import duty</label>
                        </div>
    
                        <a class="md:mt-5 cart-btn inline-block text-center w-full" href="">ADD TO CART</a>
    
                    </div>
    
                    <div class="card">
                        <div class="img-container relative">
                            <img src="/images/spiaggia_vietnam.jpg" alt="">
                        </div>
                        ...
                        <a class="md:mt-5 cart-btn cart-btn inline-block text-center w-full" href="">ADD TO CART</a>
            ...
            <section class="container mx-auto mb-24">
                ...
                <div class="md:mt-10 grid grid-cols-12">
                    ...
                    {{-- <div class="text-center bg-slate-400 ">CIAIAIAI</div> --}}
                </div>
        ...
        {{-- BODY WELCOME OLD --}}
        {{-- <div class="relative sm:flex sm:justify-center w-full sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
